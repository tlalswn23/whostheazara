...
export const ShopListTabItem = ({ index, selectTab, setSelectTab }: ShopListTabItemProps) => {
  ...
  return (
    <>
      <div
        className={`3xl:w-[240px] hover:bg-yellow-400 duration-500 w-[192px] 3xl:h-[100px] h-[80px] flex justify-center items-center 3xl:text-[32px] text-[25.6px] font-bold cursor-green rounded-2xl 3xl:mx-[40px] mx-[32px] border-solid border-white 3xl:border-[8px] border-[6.4px] shadow-black shadow-lg ${
