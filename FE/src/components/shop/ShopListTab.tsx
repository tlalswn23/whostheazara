...
export const ShopListTab = ({ selectTab, setSelectTab, selectedItems }: ShopListTabProps) => {
  ...
  return (
    <div className="flex w-[100%] justify-center 3xl:my-[10px] my-[8px]">
      ...
      >
        <div
          className={`bg-gray-700  hover:scale-125 duration-500 3xl:w-[120px] w-[96px] 3xl:h-[100px] h-[80px] flex justify-center items-center cursor-green rounded-2xl 3xl:mx-[40px] mx-[32px] border-solid border-white 3xl:border-[8px] border-[6.4px] shadow-black shadow-lg"
        }`}
        >
