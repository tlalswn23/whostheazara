...
export const HomeBtn = ({ text, index, onClick }: HomeBtnProps) => {
  ...
  const [indexStyle, setIndexStyle] = useState([
    "text-[92px] top-[-90px] left-[10px] rotate-[4deg] text-yellow-200",
    "text-[46px] top-[48px] left-[-48px] rotate-[8deg] text-white",
    "text-[52px] top-[128px] left-[96px] rotate-[-8deg] text-white",
    "text-[86px] top-[-90px] left-[0px] rotate-[4deg] text-yellow-200",
    "text-[46px] top-[48px] left-[-48px] rotate-[8deg] text-white",
